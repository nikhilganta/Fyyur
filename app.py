...
def venues():
  ...
  city_state_distinct = set()
  for venue in venues:
    city_state_distinct.add((venue.city, venue.state))
  for city_state in city_state_distinct:
    data.append({
      "city": city_state[0],
      "state": city_state[1],
      "venues": []
  ...
  for venue in venues:
    ...
    for entry in filter(lambda d: d["city"] == venue.city and d["state"] == venue.state, data):
...
def show_venue(venue_id):
  ...
  data = {
    ...
    "image_link": "https://images.unsplash.com/photo-1485686531765-ba63b07845a7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=747&q=80",
    "seeking_talent": True,
    "seeking_description": "Looking for Artists to perform at our Venue",
...
def show_artist(artist_id):
  ...
  data = {
    ...
    "image_link": "https://images.unsplash.com/photo-1558369981-f9ca78462e61?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=794&q=80",
    "seeking_venue": True,
    "seeking_description": "Looking for Venues to Perform",
    "past_shows": past_shows,
    "past_shows_count": past_shows_count,
    "upcoming_shows": upcoming_shows,
    "upcoming_shows_count": upcoming_shows_count
